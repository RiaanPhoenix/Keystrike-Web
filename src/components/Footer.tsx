      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-text-secondary text-sm">
              ...
              <li><a href="/about#leadership" className="hover:text-accent">Leadership</a></li>
              <li><a href="/careers" className="hover:text-accent">Careers</a></li>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-8">
            <a href="/privacy" className="text-text-muted text-sm hover:text-accent">Privacy Policy</a>
            <a href="/terms" className="text-text-muted text-sm hover:text-accent">Terms of Service</a>
            <a href="/security" className="text-text-muted text-sm hover:text-accent">Security</a>
            <a href="/compliance" className="text-text-muted text-sm hover:text-accent">Compliance</a>
          </div>
          <div className="mt-4 flex justify-center space-x-6">
            <a href="#" className="text-text-muted hover:text-accent">
